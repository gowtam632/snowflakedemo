CREATE SCHEMA IF NOT EXISTS HDFC_DB.ACCOUNT_SCHEMA;

-- Create Tables
CREATE TABLE IF NOT EXISTS HDFC_DB.ACCOUNT_SCHEMA.employees
...
CREATE TABLE IF NOT EXISTS HDFC_DB.ACCOUNT_SCHEMA.departments
   ( dept_id NUMBER(4)
...
INSERT INTO HDFC_DB.ACCOUNT_SCHEMA.employees VALUES 
...
INSERT INTO HDFC_DB.ACCOUNT_SCHEMA.departments VALUES 
